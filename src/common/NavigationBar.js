      ...
      <AppBar position="static" sx={{ backgroundColor: '#333333', paddingTop: 1, paddingBottom: 1 }}> {/* Change the background color here */}
        <Toolbar>
          ...
          {loggedIn ? (
              ...
              >
                ...
                >
                  ...
                  <Typography variant="body1" gutterBottom>
                    ...
                    <br />
                    Once Logout you have to signin again!
                  </Typography>
            ...
            <>
              <Link to="/signin"><Button color="inherit" variant="outlined" sx={{ marginLeft: 3, color: 'orange' }}>Sign In</Button></Link>
              <Link to="/signup"><Button color="inherit" variant="outlined" sx={{ marginLeft: 3, color: 'orange' }}>Sign Up</Button></Link>
            </>
          )}
        </Toolbar>
      </AppBar>
