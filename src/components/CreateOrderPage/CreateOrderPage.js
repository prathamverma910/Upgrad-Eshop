...
export default function CreateOrderPage() {
    ...
    async function addAddressHandler(event) {
        ...
        try {
            // Send the address data to the server using fetch
            const rawResponse = await fetch('http://localhost:3001/api/v1/addresses', {
                method: 'POST',
                headers: {
            ...
            if (rawResponse.ok) {
                // Successful address addition, you can redirect the user to anotherpage or show a success message
        ...
        <div>
            ...
            <footer className="footer">
                <Typography variant="body2" className="footer">
                    ...
                    <br />
                    ©2024, Upgrad Eshop, Pratham Verm, Inc. or its affiliates
                </Typography>
            </footer>
        </div>
    );
